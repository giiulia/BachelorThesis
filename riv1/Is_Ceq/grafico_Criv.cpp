...
//manipolazione dati ed errori (cambiando a 2% l'errore di TUTTE le misure vengono errori sulle Criv di decine di pF rispetto a 4pF di prima)
  	double Ccavo_Cs [] = {128, 5}; // in pF 	ERRORE=2% invece di 3 pF 
...
//grafico
    ...
    //c.Print("Grafici/grafico_Criv.pdf", "pdf") ; 
